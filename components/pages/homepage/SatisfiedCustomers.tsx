...
export default function SatisfiedCustomers() {
    ...
    const currentTestimonials = testimonials.slice(startIndex, startIndex + cardsPerSlide);
    ...
    }, [cardsPerSlide]); // Re-run if cards per slide changes
        ...
        return (
            <>
                {Array.from({ length: filledStars }, (_, i) => (
                    <svg key={i} className='w-[16px] h-[16px] fill-[#FCD34D]' viewBox='0 0 20 20'>
                        <path d='M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z' />
                    </svg>
                ))}
                {Array.from({ length: emptyStars }, (_, i) => (
                    <svg key={i} className='w-[16px] h-[16px] fill-gray-200' viewBox='0 0 20 20'>
                        <path d='M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z' />
                    </svg>
                ))}
            </>
        ...
        <div className='w-full bg-white py-[48px] px-[24px] md:px-[48px] lg:px-[80px]'>
            <div className='max-w-[1200px] mx-auto'>
                ...
                <div className='flex items-center justify-between mb-[48px]'>
                    <h2 className='text-[28px] md:text-[32px] font-medium text-[#4B5563] leading-[1.2]'>Satisfied Customers</h2>
                    <div className='flex items-center gap-[12px]'>
                        ...
                        <button
                            onClick={nextSlide}
                            className='w-[44px] h-[44px] rounded-full bg-[#030712] hover:bg-[#111827] transition-colors duration-200 flex items-center justify-center'
                        >
