...
const Payment = lazy(() => import("./Payment/page"));
const Review = lazy(() => import("./ReviewPage/page"));
...
export default function CheckoutPage() {
  ...
  return (
    <>
      ...
      {/* <Header /> */}
      <main>
        <section className="flex flex-wrap bg-background  text-primary justify-center gap-[5rem]">
          ...
          <div className="w-[34rem] ">
            ...
            <div className="w-[23rem] mr-[24rem] mb-[1.5rem]  bg-[#FFF5EA]  border border-[#FFE4C7] h-[3.2rem] rounded-[0.63rem] ">
              <p className="pt-[1rem] pb-[2rem] pl-[1.2rem]  pr-[4.55rem] font-light text-[0.7rem]">
